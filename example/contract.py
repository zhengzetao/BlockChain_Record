...
w3.personal.unlockAccount(w3.eth.accounts[0], "123456", 0)
...
def upload(ins, filehash, filename, filesize, owner,operation):
    logger.info("Call upload")
    logger.info("{}, {}, {}, {},{}".format(owner, filehash, filename, filesize, operation))
